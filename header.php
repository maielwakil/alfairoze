...
?>
<?php
if ($offer_url == "/department/nesaa") {
  $theme_name='gynaecology';
}
else{$theme_name='primary';}
?>

<html lang="ar" dir="rtl" theme="<?php echo $theme_name;?>">
<head>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="<?php echo get_theme_file_uri(); ?>/style.css">
  	<link id="favicon" rel="shortcut icon" href="<?php echo get_theme_file_uri(); ?>/favicon.ico" sizes="16x16 32x32 48x48" type="image/png">
  	<?php wp_head(); ?>
</head>
